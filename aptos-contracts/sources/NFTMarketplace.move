address 0xf7f6871445983573a0a6b6c5511e0225fa829d696dab24c96a0a3ba40bc0de82 {
    module V3 {
        use 0x1::signer;
        use 0x1::vector;
        use 0x1::coin;
        ...
        public entry fun mint_nft(
            ...
            let store = borrow_global_mut<NFTStore>(@0xf7f6871445983573a0a6b6c5511e0225fa829d696dab24c96a0a3ba40bc0de82);
            let nft = NFT {
        ...
        public fun get_user_nfts(user_addr: address): vector<NFTInfo> acquires NFTStore {
            let store = borrow_global<NFTStore>(@0xf7f6871445983573a0a6b6c5511e0225fa829d696dab24c96a0a3ba40bc0de82);
